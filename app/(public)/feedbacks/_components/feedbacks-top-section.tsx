  ...
  return (
    <Section className="relative pb-0 overflow-hidden mx-0 max-w-full md:max-w-full">
      <div className="relative z-10 flex flex-col justify-center items-center">
        ...
        <p className="text-primary-blue font-medium lg:text-2xl mt-10 lg:mt-[64px] text-center">
          [ Список відгуків від учнів Niko IT Academy ]
        </p>
      </div>

      <div className="absolute -right-12 lg:right-0 top-16 lg:top-[400px] w-[142px] h-[142px] lg:w-[362px] lg:h-[362px]">
        <Image
          src={feedbackImage2}
      ...
      <div className="absolute left-5 top-[104px] w-[142px] h-[142px] lg:w-[362px] lg:h-[362px]">
        <Image
          src={feedbackImage1}
