export const CourseInformation = () => {
  return (
    <div className="grid lg:grid-cols-3 gap-x-6 gap-y-8">
      <div className="w-full bg-secondary-black lg:py-14 lg:px-32 md:p-10 flex justify-between rounded-3xl col-span-2">
      ...
      <div className="w-full bg-primary-accent lg:py-14 lg:px-32 md:p-10 flex justify-between rounded-3xl">
        <div>
          <div className="text-primary-white font-unbounded md:text-3xl lg:text-4xl lg:mb-4">
            Старт курсу
          </div>
