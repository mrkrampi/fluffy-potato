...
export const WhyUsCard = ({ item: { count, title, description } }: WhyUsCardProps) => {
  return (
    <div className="px-2 py-6 md:px-6 md:py-4 lg:px-8 lg:py-6 rounded-2xl bg-primary-white flex flex-col items-center justify-center h-full w-full md:w-[280px] lg:w-sm text-center">
      ...
      <div className="text-primary-black font-unbounded text-sm md:text-base lg:text-xl">{description}</div>
    </div>
  );
};
