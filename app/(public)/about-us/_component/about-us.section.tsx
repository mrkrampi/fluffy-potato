  ...
  return (
    <Section className="flex flex-col md:flex-row gap-y-8 md:gap-4 lg:gap-14 lg:items-center relative z-10">
      ...
      <BlurredParagraph className="font-medium lg:text-2xl">
        Niko IT Academy це українсько - канадська онлайн академія заснована у 2020 році викладачем та експертом в IT індустрії - Наталі Яцишинець. Головна ціль академії - надати студентам шанс отримати цінний досвід та створити власний проєкт, під керівництвом досвідченого вчителям та успішного IT-фахівця. Ми слідкуємо за розвитком та тенденціями ринку, для випуску цінних фахівців у своїй галузі, а також даємо найбільш корисну інформацію, яка у майбутньому допомагає студентам отримати бажану роботу.
        <br/>
        <br/>
