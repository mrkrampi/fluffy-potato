    ...
    <footer className="w-full h-full bg-primary-black md:pt-[100px] lg:pt-[200px]">
      <div className="border-l-primary-white md:pt-0 border-b-2">
        <div className="flex-col md:flex-row w-full py-2 px-2 md:px-8 xl:py-20 xl:px-24 flex justify-between items-center">
          ...
          <div className="flex flex-col my-20 md:my-0 max-w-[320px] w-full">
            <div className="text-primary-white md:max-w-80 text-2xl text-center font-unbounded leading-tight uppercase">
      ...
      <div className="flex-col md:flex-row gap-y-4 py-2 px-3 md:p-8 xl:px-24 xl:py-12 flex justify-between items-center text-primary-white">
        <div className="text-sm lg:text-base">
          Niko IT Academy. Усі права захищені © {new Date().getFullYear()}
        </div>

        <div className="flex gap-x-4">
          <a href="/offert" className="text-sm lg:text-xl text-primary-gray underline">Договір оферти</a>
          <a href="/usage-policy" className="text-sm lg:text-xl text-primary-gray underline">Політика конфіденційності</a>
        </div>
